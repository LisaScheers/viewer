...
struct FakeState
{
    ...
    FakeState()
    {
        ...
        mSwapchainFormatProperties.optimalTilingFeatures = VK_FORMAT_FEATURE_TRANSFER_DST_BIT;
    }
};
...
using render_vulkan_instance_test_group  = test_group<render_vulkan_instance_test, 76>;
