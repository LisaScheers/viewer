...
LLWindowMacOSXVulkan::acquireSwapchainPresentationTargetGeneration() noexcept
{
    using namespace LLRenderVulkan;
...
LLWindowMacOSXVulkan::acquireRenderPassClearToPresentSwapchainFrameSlot(
    const LLRenderVulkan::VulkanSwapchainFrameClearColor& clear_color) noexcept
{
    using namespace LLRenderVulkan;
...
LLRenderVulkan::VulkanSwapchainFrameSlotParentPresentationResult LLWindowMacOSXVulkan::acquireRenderPassDrawToPresentSwapchainFrameSlot(
    const LLRenderVulkan::VulkanSwapchainFrameClearColor& clear_color) noexcept
{
    using namespace LLRenderVulkan;
